@ECHO off
CD ""
CALL "" http://rxpresales006/jira/ automationuser rxtest FailingTest  RXDEM "Bug" "" "{LB} " "C:\Users\hhafner\Documents\Ranorex\RanorexStudio Projects\JiraDemoSolution\JiraDemoSolution\bin\Debug\JiraDemoSolution_20171018_093215.rxzlog" ""  %* > return_string_FailingTest.txt
